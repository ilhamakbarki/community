"""Barqfleet carrier tracking tests."""
...
class TestBarqfleetTracking(unittest.TestCase):
    def setUp(self):
        self.maxDiff = None
    ...
    def test_get_tracking(self):
        with patch("karrio.mappers.barqfleet.proxy.lib.request") as mock:
            mock.return_value = "{}"
